...
impl Plugin for EditorPlugin {
    fn build(&self, app: &mut App) {
        app
        .insert_resource(NodeGraphExample::default())/* .insert_resource(EditorState::default()) */
            .add_system(setup);
    }
}
/*
...
fn setup(
    ...
    mut node_graph: ResMut<NodeGraphExample>, /* , mut editor_state: ResMut<EditorState> */
) {
    let ctx = ctx.ctx_mut();
    egui::TopBottomPanel::top("menu").show(ctx, |ui| {
        egui::menu::bar(ui, |ui| {
            egui::menu::menu_button(ui, "Press", |ui| {
...
impl NodeGraphExample {
    fn update(&mut self, ctx: &egui::Context) {
        let graph_response = egui::CentralPanel::default()
            .show(ctx, |ui| {
                self.state.draw_graph_editor(ui, AllMyNodeTemplates, &mut self.user_state)
            })
            .inner;
    }
}
